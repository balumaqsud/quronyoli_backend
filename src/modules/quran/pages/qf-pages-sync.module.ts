...
import { QfPagesSyncService } from './qf-pages-sync.service';
import { QfPagesRepository } from './qf-pages.repository';
...
@Module({
  ...
  exports: [QfPagesSyncService],
})
export class QfPagesSyncModule {}
