...
| `image_url` / `image_width` | Optional full-page art for image mushafs (id 10 Dar al-Marefa; id 1405 classic Medina when configured). Verse-level QF ayah-strip URLs are never stored as page art. |
